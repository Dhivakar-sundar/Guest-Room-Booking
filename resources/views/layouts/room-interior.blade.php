...
<x-app-layout>
    ...
    * {
    ...
    <div class="modal fade book-now-modal-lg{{$image->id}}" tabindex="-1" role="dialog"
        aria-labelledby="bookNowModalLarge" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="reservationModalBody">
                    <form role="form" autocomplete="off" method="post" id="myform" action="{{route('booking')}}">
                        @csrf
                        <div class="rsvnTab">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="room_id" value="{{$image->id}}">
                                        <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                                        <input type="hidden" name="admin_id" value="{{$image->admin_id}}">


                                        <!-- <input type="date" class="form-control" name="start_date" id="txtFormDate" required> -->
                                        <input type="date" class="form-control" name="start_date" id="txtFormDate"
                                            required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <!-- <input type="date" class="form-control" min="" id="txtToDate" name="end_Date" required> -->
                                        <input type="date" class="form-control" name="end_Date" id="txtToDate" required>
                            ...
                            <div class="form-group row align-items-center">
                                <label class="col-sm-3 col-form-label" for="">Staying Days
                                    <span class="red-asterisk"> *</span>
                                </label>
                                <div class="col-sm-9">
                                    <input type="number" name="days" id="days" class="form-control" value=""
                                        min="{{$image->min}}" max="{{$image->max}}" >
                                </div>
                            </div>

                            <div class="form-group row align-items-center">
                                <label class="col-sm-3 col-form-label" for=" ">Rent Per Day
                                    <span class="red-asterisk">*</span>
                                </label>
                                <div class="col-sm-9">
                                    <input type="text" name="rent" id="" class="form-control"
                                        value="{{$image->rent}} / ₹" required>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <select required class="custom-select mr-sm-2" name="type">
                                        <option value="{{$image->bed}}" selected>{{$image->bed}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                <label class="col-sm-3 col-form-label" for="specialRequests">Special
                                    requirements</label>
                                <div class="col-sm-9">
                                    <textarea rows="3" maxlength="500" name="requirement" class="form-control"
                                        required></textarea><span>If no requirements then fill Null</span>
                                </div>

                            </div>
                            <input type="text" name="books_status" value="PENDING" hidden>
                            <input type="text" name="payment" value="PENDING" hidden>



                            <a tabindex="0" class="btn btn-info" role="button" data-bs-toggle="popover"
                                data-bs-trigger="focus" title=""
                                data-bs-content="Minimum of {{$image->min}} day and Maximum booking duration can only be {{$image->max}} days">
                                Check-in policies</a>
